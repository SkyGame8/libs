...
const char* GetSendHeaderName(BYTE header)
{
	...
	if (b == false)
	{
...
#if defined(ENABLE_MULT_ITEM_USE)
		stringList[24] = "HEADER_CG_MULTI_ITEM_USE";
#endif
		...
		stringList[131] = "HEADER_CG_LOGIN3";
		...
		stringList[217] = "HEADER_CG_DRAGON_SOUL_REFINE_ALL";
#endif
#ifdef ENABLE_CAPTCHA
		stringList[238]     = "HEADER_CG_CAPTCHA";
#endif
#ifdef ENABLE_CSHIELD
		stringList[239]     = "HEADER_CG_CSHIELD_DATA";
		stringList[240]     = "HEADER_CG_CSHIELD";
#endif
#if defined(__IMPROVED_PACKET_ENCRYPTION__)
...
#ifdef ENABLE_CAPTCHA
        stringList[48]      = "HEADER_GC_CAPTCHA";
#endif
...
#ifdef ENABLE_CSHIELD
        stringList[240]     = "HEADER_GC_CSHIELD";
#endif
#if defined(__IMPROVED_PACKET_ENCRYPTION__)
